...
///////////////// MINI_PP_PRIVATE_IS_INT_IMPL_ /////////////////
#define CHECK_IS_INT(params, x) + MINI_PP_CAT(0, MINI_PP_CAT(MINI_PP_PRIVATE_IS_INT_IMPL_, x))
static_assert(42 CALL_UNROLL(MINI_PP_CAT(MINI_PP_PRIVATE_LOOP_UNROLL_, MINI_PP_MAX_NB_ARGS), CHECK_IS_INT, /*dummyParams,*/ MINI_PP_PRIVATE_ARG_SEQ_MAX_TO_0) == 42, "MINI_PP_PRIVATE_IS_INT_IMPL_ is broken");
static_assert(42 CHECK_IS_INT(dummyParams, MINI_PP_MAX_NB_ARGS) == 42, "MINI_PP_PRIVATE_IS_INT_IMPL_ is broken");

///////////////// MINI_PP_PRIVATE_IS_EQUAL_IMPL_ /////////////////
