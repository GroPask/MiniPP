...
static_assert(42 MINI_PP_EXPAND(MINI_PP_DEFER(MINI_PP_CAT(MINI_PP_PRIVATE_LOOP_UNROLL_, MINI_PP_MAX_NB_ARGS))(MY_FUNC, dummyParams, MINI_PP_PRIVATE_ARG_SEQ_MAX_MINUS_ONE_TRUE_THEN_FALSE)) == 42 + MINI_PP_MAX_NB_ARGS - 1, "MINI_PP_PRIVATE_LOOP_UNROLL_ is broken");
