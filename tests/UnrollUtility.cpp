...
static_assert(MINI_PP_CALL_WITH_ARGS(MINI_PP_PRIVATE_GET_ARG_INDEX_MAX, MINI_PP_PRIVATE_ARG_SEQ_MAX_MINUS_ONE_TRUE_THEN_FALSE, 42) == 42, "MINI_PP_PRIVATE_GET_ARG_INDEX_MAX is broken");
static_assert(MINI_PP_CALL_WITH_ARGS(MINI_PP_PRIVATE_GET_ARG_INDEX_MAX, MINI_PP_PRIVATE_ARG_SEQ_MAX_TO_0) == 0, "MINI_PP_PRIVATE_GET_ARG_INDEX_MAX is broken");
