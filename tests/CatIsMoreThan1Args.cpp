...
static_assert(MINI_PP_CAT_IS_MORE_THAN_1_ARGS(4) == 40, "MINI_PP_CAT_IS_MORE_THAN_1_ARGS is broken");
...
static_assert(CALL_IS_MORE_THAN_1_ARGS() == 40, "MINI_PP_CAT_IS_MORE_THAN_1_ARGS is broken");
...
static_assert(MINI_PP_CAT(4, MINI_PP_CAT_IS_MORE_THAN_1_ARGS(4)) == 440, "MINI_PP_CAT_IS_MORE_THAN_1_ARGS is broken");
...
static_assert(MINI_PP_CAT(4, CALL_IS_MORE_THAN_1_ARGS()) == 440, "MINI_PP_CAT_IS_MORE_THAN_1_ARGS is broken");
